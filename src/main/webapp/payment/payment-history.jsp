<%@ page import="com.app.medicine.model.Payment" %>
...
<div class="max-w-6xl mx-auto">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="admin-dashboard" class="bg-darkest hover:bg-dark text-white font-bold py-2 px-4 rounded">Back to Dashboard</a>
    </div>

    <div class="overflow-x-auto">
        <table class="min-w-full bg-white rounded-lg overflow-hidden">
            <thead class="bg-darkest text-light">
            <tr>
